...
def run_check():
    ...
    for pipeline_file in pipeline_files:
        ...
        pipeline_app.set_attribute("repo_scan_start_time", datetime.now())
        ...
        pipeline_app.set_attribute("scm_repo_primary_branch_head_commit_date", datetime.strptime(pipeline_repo_primary_branch_head_commit.last_modified, settings.GIT_DATE_FORMAT))
        try:
